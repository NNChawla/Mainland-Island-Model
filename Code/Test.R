VMM <- function(container, nI = 5, graphStep = 1, replicates = 10, e = 0.01, kl = 5000) {
  tic()
  ...
  toc()
  return(list(tbFrames(frames, replicates), container$parms, timeMatrix(frames), pathLDRatios))
}