...
nStarGraph <- function(container, Nstar, interval = 0.5, nI = 5, replace_sp = TRUE) {
  ...
  subsetMelt <- melt(subset[[1]]["Between"], id.vars = "time") #arbitrary one, we can combien the betweens maybe and make something cool out of that
